...
public final class ViewfinderView extends View {
    ...
    public void initConfig() {
        maskColor = getResources().getColor(R.color.black_80);
        angleColor = getResources().getColor(R.color.white);
        mTipmMargin = 40;
        mSlideIcon = getResources().getDrawable(R.mipmap.capture_add_scanning);
    }
